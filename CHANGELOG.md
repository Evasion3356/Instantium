...
- Smoke-tested in-game for startup, Mourningstar/Psykhanium transitions, fixed and Quickplay missions, Expedition, selected-mission tier scope and cleanup, squad loadouts, tier changes, disable/re-enable, and shutdown cleanup.
